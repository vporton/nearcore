...
#[derive(
    BorshSerialize, BorshDeserialize, Serialize, Deserialize, Hash, PartialEq, Eq, Clone, DeepSizeOf,
)]
...
#[derive(BorshSerialize, BorshDeserialize, Serialize, Hash, PartialEq, Eq, Clone, DeepSizeOf)]
